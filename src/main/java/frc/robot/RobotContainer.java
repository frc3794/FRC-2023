...
public class RobotContainer {
  ...
  private final Autos m_auto = new Autos (m_drivetrain, m_armJoint, m_claw, m_indexer);

  public RobotContainer() {
    SmartDashboard.putString("DB/String 5", "0: Fuera");
    SmartDashboard.putString("DB/String 6", "1: Charging");
    SmartDashboard.putString("DB/String 7", "2: Cubo y fuera");
    SmartDashboard.putString("DB/String 8", "3: Cubo 2 Y Charging");
    SmartDashboard.putString("DB/String 9", "NO: MASTER");
  }
  ...
  public Command getAutonomousCommand() {
    ...
    if (buttonValue && !buttonValue1 && !buttonValue2 && !buttonValue3) {
      ...
      SmartDashboard.putString("DB/String 9", "Not value on button");
      level = 14;
    }
